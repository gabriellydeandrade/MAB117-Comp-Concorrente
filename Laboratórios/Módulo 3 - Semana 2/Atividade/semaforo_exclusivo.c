...
sem_t em_escrita, em_leitura, cond_escrita, cond_leitura;
...
void *leitor(void * arg){
    ...
    while(1){
        ...
        sem_wait(&em_leitura); qtd_leitores++;
...
void *escritor(void * arg){
    ...
    while(1){
        ...
        sem_wait(&em_escrita); qtd_escritores++;
...
int main(void){
    ...
    //inicia os semaforos
    sem_init(&em_escrita, 0, 1); //mutex
    sem_init(&em_leitura, 0, 1); //mutex
